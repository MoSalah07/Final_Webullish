...
function SwitchSetting() {
  return (
    <div className="w-full h-full flex flex-col justify-end items-center lg:items-start gap-4 capitalize mb-12 mt-24">
      <Link
      ...
      >
        ...
        <span className="hidden lg:block md:text-lg">settings</span>
      </Link>
      <Link
        className="flex items-center justify-center gap-2 text-text-light "
        href={`/`}
      >
        ...
        <span className="hidden lg:block md:text-lg">logout</span>
      </Link>
    </div>
  );
}
