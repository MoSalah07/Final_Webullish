...
// Components
import FAQComponent from "@/app/components/utils/FAQComponent";
// Fetch Data
...
function NotificationCard({ name, description, toggle, id, open }) {
  ...
  const handleDeleteFqs = async (e, id) => {
    ...
    try {
      const { data } = await axios({
        url: `${process.env.NEXT_PUBLIC_URL_BD}/api/top_notification/delete/${id}`,
        method: "POST",
        headers: {
