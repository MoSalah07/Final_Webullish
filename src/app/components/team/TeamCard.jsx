  ...
  return (
    <div className='border-2 border-border-color'>
      ...
      <div className='flex items-center justify-between p-4'>
        ...
        <button onClick={(e) => handelDeleteTeam(e, id)} className='py-[6px] px-5 rounded-primary-rounded capitalize text-sm bg-primary-red text-primary-white'>delete</button>
      </div>
    </div>
  )
}
